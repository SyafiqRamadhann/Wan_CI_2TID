...
class Mahasiswa extends CI_Controller
{
  ...
  public function tambah()
  {
    ...
    if ($this->form_validation->run() == false){
      $this->load->view("layout/header",$data);
      $this->load->view("mahasiswa/vw_tambahdata",$data);
    ...
    function edit($id)
{
  ...
  public function hapus($id)
  {
    ...
    $this->session->set_flashdata('message','<dic class="alert alert-succes" role="alert">Data Mahasiswa Berhasil Dihapus!</div>');
    redirect('Mahasiswa');
